...
type CourseProtoClient interface {
	PostCourse(ctx context.Context, in *Course, opts ...grpc.CallOption) (*RequestCompleted, error)
}
...
func (c *courseProtoClient) PostCourse(ctx context.Context, in *Course, opts ...grpc.CallOption) (*RequestCompleted, error) {
	out := new(RequestCompleted)
...
type CourseProtoServer interface {
	PostCourse(context.Context, *Course) (*RequestCompleted, error)
...
func (UnimplementedCourseProtoServer) PostCourse(context.Context, *Course) (*RequestCompleted, error) {
